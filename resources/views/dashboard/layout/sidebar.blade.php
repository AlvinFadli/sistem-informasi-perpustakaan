<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " style="overflow: hidden;" id="sidenav-main" >
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-book navbar-brand-img h-100" viewBox="0 0 16 16">
        ...
        <span class="ms-1 font-weight-bold">Pustaka Dashboard</span>
      </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="collapse navbar-collapse min-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('dashboard-buku')?'active':''}} @yield('dashboard-buku')" href="{{url('dashboard-buku')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('dashboard/pengarang')?'active':''}} @yield('dashboard-penulis')" href="/dashboard/pengarang">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('dashboard/penerbit')?'active':''}} @yield('dashboard-penerbit')" href="/dashboard/penerbit">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('dashboard/pegawai')?'active':''}} @yield('dashboard-pegawai')" href="/dashboard/pegawai">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('dashboard/jadwal')?'active':''}} @yield('dashboard-jadwal')" href="/dashboard/jadwal">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
