...
@section('dashboard-page','Penulis')
@section('container')
    <div class="container">
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <a href="pengarang/create" class="btn bg-gradient-warning mb-3">Tambah Penulis</a>
      </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <span class="text-xs font-weight-bold">{{substr($pengarang->alamat,0,20)}}...</span>
                    </td>
                    <td class="align-middle">
                      <span class="text-xs font-weight-bold">{{$pengarang->email}}</span>
                    </td>
                    <td class="align-middle text-center">
                      <a href="/dashboard/pengarang/{{$pengarang->id}}/edit" class="btn bg-gradient-warning" style="padding: 8px 10px; margin:0"><i class="bi bi-pencil-square"></i></a>
                      <form action="/dashboard/pengarang/{{$pengarang->id}}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
